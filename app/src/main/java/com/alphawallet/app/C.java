...
public abstract class C {
    ...
    public static final int ACTIVITY_HISTORY_LENGTH = 100; // Added by HFT

    public static final String HFTC_NETWORK_NAME = "HFTC Mainnet"; // Added by HFT
    public static final String HFTC_SHORT_NETWORK_NAME = "HFTC"; // Added by HFT
    ...
    public static final String HFTC_NAME = "HFTCoin"; // Added by HFT

    public static final String USD_SYMBOL = "$";
    public static final String HFTC_SYMBOL = "HFTC"; // Added by HFT
    ...
    public static final String HFTC_TOKEN = "0x1932c48b2bf8102ba33b4a6b545c32236e342f34"; // Added by HFT
    ...
    public static final String HFTC_WEBSITE = "https://hftcoin.org"; // Added by HFT
    public static final String BUY_HFTC_URL = "https://hftcoin.org/#buy-hftc";
    ...
    public static final int HFTC_DECIMALS = 18; // Added by HFT
