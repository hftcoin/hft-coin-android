    ...
    public void setSelectedItem(WalletPage index) {
        ...
        switch (index) {
            case DAPP_BROWSER:
                ...
                dappBrowserLabel.setTextColor(getResources().getColor(R.color.hftc, getContext().getTheme()));
                break;
            case WALLET:
                wallet.setImageResource(R.drawable.ic_tab_wallet_active);
                walletLabel.setTextColor(getResources().getColor(R.color.hftc, getContext().getTheme()));
                break;
            case SETTINGS:
                settings.setImageResource(R.drawable.ic_tab_settings_active);
                settingsLabel.setTextColor(getResources().getColor(R.color.hftc, getContext().getTheme()));
                break;
            case ACTIVITY:
                activity.setImageResource(R.drawable.ic_tab_activity_active);
                activityLabel.setTextColor(getResources().getColor(R.color.hftc, getContext().getTheme()));
                break;
        }
    }
