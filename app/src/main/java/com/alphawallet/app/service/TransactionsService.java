...
public class TransactionsService
{
    ...
    private void fetchTransactions()
    {
        ...
        {
            // TODO: HFT, interval = 2.5 x 2
            erc20EventCheckCycle = Observable.interval(0, 2500, TimeUnit.MILLISECONDS)
        ...
        {
            // TODO: HFT
            pendingTransactionFetch = Observable.interval(2, 2, TimeUnit.SECONDS)
    ...
    private Transaction storeRawTx(EthBlock ethBlock, int chainId, EthGetTransactionReceipt receipt, EthTransaction txDetails, String currentWallet)
    {
        ...
        {
            // Modified by HFT
            return transactionsCache.storeRawTx(new Wallet(currentWallet), chainId, txDetails, Utils.ToTimeStamp(ethBlock.getBlock().getTimestamp()), receipt.getResult().getStatus().equals("0x1"));
        }
        else
        {
