                                                            ...
                                                            TokenScriptRenderCallback, WebCompletionCallback, OnSetValuesListener
{
    ...
    private void setupFunctions()
    {
        if (token != null)
        {
            ...
            {
                // functions.add(R.string.speedup_transaction); // Modified by HFT
                functions.add(R.string.go_to_token);
                // functions.add(R.string.cancel_transaction); // Modified by HFT
            }
            else
            {
                functions.add(R.string.go_to_token);
    ...
    private void handleTransaction(Wallet wallet)
    {
        ...
        TextView toValue = findViewById(R.id.to);  // Added by HFT
        //date. Modified by HFT
        eventTime.setText(Utils.localiseUnixDate(getApplicationContext(), transaction.timeStamp));
        //icon
        ...
        // toValue.setText(transaction.getOperationDetail(this, token, )); // Added by HFT
