        ...
        BackupTokenCallback
{
    ...
    private ImageButton scanQrIcon;
    private ImageButton qrIcon;
    ...
    private void initToolbar(View view) {
        scanQrIcon = view.findViewById(R.id.action_scan);
        qrIcon = view.findViewById(R.id.action_my_wallet);
        scanQrIcon.setVisibility(View.VISIBLE);
        qrIcon.setVisibility(View.VISIBLE);
        scanQrIcon.setOnClickListener(new View.OnClickListener() {
            @Override
    ...
    private void initList() {
        ...
        // Disable item touch. Modified by HFT
