    ...
    public BinderViewHolder<?> onCreateViewHolder(ViewGroup parent, int viewType) {
        switch (viewType) {
            case TransactionHolder.VIEW_TYPE:
                TransactionHolder transactionHolder = new TransactionHolder(parent, tokensService,
                        fetchTransactionsInteract, assetService);
                if (startNewDate) {
                    startNewDate = false;
                    transactionHolder.hideSeparatorLine();
                }
            ...
            case TransactionDateHolder.VIEW_TYPE:
                startNewDate = true;
                TransactionDateHolder transactionDateHolder =  new TransactionDateHolder(R.layout.item_transactions_date_head, parent);
                if (isFirstDate) {
                    isFirstDate = false;
                    transactionDateHolder.hideTopSeparatorLine();
                }

                return transactionDateHolder;
            // Modified by HFT
            /*
