...
public class SplashActivity extends BaseActivity implements CreateWalletCallbackInterface, Runnable
{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // long getAppUpdateTime = getAppLastUpdateTime(); // Modified by HFT

        splashViewModel.fetchWallets();
        // splashViewModel.checkVersionUpdate(getBaseContext(), getAppUpdateTime); // Modified by HFT
    ...
    private void onWallets(Wallet[] wallets) {
        ...
        if (wallets.length == 0)
        {
            ...
            findViewById(R.id.splash_app_name).setVisibility(View.VISIBLE);
            findViewById(R.id.splash_slogan).setVisibility(View.VISIBLE);
